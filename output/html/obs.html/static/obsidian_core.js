...
var html_url_prefix = "/wiki/output/html";
var CONFIGURED_HTML_URL_PREFIX = "/wiki/output/html";
...
var gzip_hash = '167522926746584759703975550058967712704'                       // used to check whether the localStorage data is stale
...
function get_html_url_prefix(){
    return '/wiki/output/html'  // this value is replaced by the actual url prefix when compiled
}
